...
public class PlayerList {
	...
	protected static final Class<?> PROPERTYCLASS = a() ? ReflectionUtil.getMojangAuthClass("properties.Property")
			: null;
	public static final Constructor<?> GAMEPROPHILECONSTRUCTOR = a()
			? (Constructor<?>) ReflectionUtil.getConstructor(GAMEPROFILECLASS, UUID.class, String.class).get()
			: null;
	public static final Class<?> CRAFTPLAYERCLASS = ReflectionUtil.getCraftbukkitClass("CraftPlayer", "entity");
	public static final Object WORLD_GAME_MODE_NOT_SET;
	public static final Class<?> CRAFT_CHAT_MESSAGE_CLASS = a()
			? ReflectionUtil.getCraftbukkitClass("CraftChatMessage", "util")
			: null;
	public static final Class<?> PACKET_PLAYER_INFO_PLAYER_ACTION_CLASS = a()
			? ReflectionUtil.getNMSClass("PacketPlayOutPlayerInfo$EnumPlayerInfoAction")
			: null;
	public static final Object PACKET_PLAYER_INFO_ACTION_REMOVE_PLAYER = a()
			? ReflectionUtil.getEnumConstant(PACKET_PLAYER_INFO_PLAYER_ACTION_CLASS, "REMOVE_PLAYER")
			: null;
	public static final Object PACKET_PLAYER_INFO_ACTION_ADD_PLAYER = a()
			? ReflectionUtil.getEnumConstant(PACKET_PLAYER_INFO_PLAYER_ACTION_CLASS, "ADD_PLAYER")
			: null;
	public static final Class<?> PACKET_CLASS = ReflectionUtil.getNMSClass("Packet");
	public static final Class<?> I_CHAT_BASE_COMPONENT_CLASS = a() ? ReflectionUtil.getNMSClass("IChatBaseComponent")
			: null;
	public static final Constructor<?> PACKET_PLAYER_INFO_DATA_CONSTRUCTOR;

	public static Class<?> PACKET_HEADER_FOOTER_CLASS;
	public static Constructor<?> PACKET_HEADER_FOOTER_CONSTRUCTOR = null;
	public static Class<?> CHAT_SERIALIZER;

	public static Class<?> PROPERTY;
	public static Constructor<?> PROPERTY_CONSTRUCTOR;

	public static Class<?> PROPERTY_MAP;

	public static Object invokeChatSerializerA(String text) {
	...
	public final static String[] colorcodeOrder = "0123456789abcdef".split("");
	public final static String[] inviscodeOrder = { ",", ".", "\'", "`", " " };
	...
	public Map<Integer, String> datasOLD = new HashMap<Integer, String>();
	...
	public static final HashMap<UUID, PlayerList> lookUpTable = new HashMap<>();
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void removeCustomTab(int id, boolean remove) {
		Object packet = ReflectionUtil
				.instantiate((Constructor<?>) ReflectionUtil.getConstructor(PACKET_PLAYER_INFO_CLASS).get());
		if (ReflectionUtil.getInstanceField(packet, "b") instanceof List) {
			List<Object> players = (List<Object>) ReflectionUtil.getInstanceField(packet, "b");
	 ...
	 */
	@Deprecated
	public void addValue(int id, String name, boolean shouldUseSkin) {
	...
	@SuppressWarnings("unchecked")
	@Deprecated
	public void addValue(int id, String name, UUID uuid, boolean updateProfToAddCustomSkin) {
		Object packet = ReflectionUtil
				.instantiate((Constructor<?>) ReflectionUtil.getConstructor(PACKET_PLAYER_INFO_CLASS).get());
		if (ReflectionUtil.getInstanceField(packet, "b") instanceof List) {
			List<Object> players = (List<Object>) ReflectionUtil.getInstanceField(packet, "b");
	...
	public static void sendNEWTabPackets(Player player, Object packet, List<?> players, Object action) {
		try {
	...
	public static void sendOLDTabPackets(Player player, Object packet, String name, boolean isOnline) {
		try {
	...
	public static int getIDFromName(String id) {
		String[] a = colorcodeOrder;
		int size1 = 15;
		int indexAdder = 0;
		if (!a()) {
...
class Skin implements ConfigurationSerializable {
	...
	// public static final LoadingCache<UUID, Skin> SKIN_CACHE = CacheBuilder
	public static final Object SKIN_CACHE = CacheBuilder.newBuilder().expireAfterWrite(5, TimeUnit.MINUTES)
 ...
 */
class MojangAPIUtil {
	public static URL API_STATUS_URL = null;
	public static URL GET_UUID_URL = null;
	...
	public static RequestResult makeSyncGetRequest(URL url) {
		if (plugin == null) {
			return null;
		}
	...
	public static void makeAsyncGetRequest(URL url, RequestCallBack asyncCallBack) {
		if (plugin == null) {
			return;
		}
		new BukkitRunnable() {
	...
	public static RequestResult makeSyncPostRequest(URL url, String payload) {
		if (plugin == null) {
			return null;
		}
		StringBuilder response = new StringBuilder();
	...
	public static void makeAsyncPostRequest(URL url, String payload, RequestCallBack asyncCallBack) {
		if (plugin == null) {
			return;
		}
		new BukkitRunnable() {
