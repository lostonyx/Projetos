...
public final class SpigotAPI {
	 ...
	 */
	public static void sendClickable(Player player, String clickMessage, String hoverMessage, String command) {
	 ...
	 * @return Componente
	 */
	public static TextComponent getClickable(String message, String hoverMessage, String command) {
