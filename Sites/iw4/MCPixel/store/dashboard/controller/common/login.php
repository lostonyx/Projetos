...
class ControllerCommonLogin extends Controller {
	...
	public function index() {
		...
		if ($this->user->isLogged() && isset($this->request->get['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			$this->response->redirect($this->url->link('dashboard/common/dashboard', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		$data['action'] = $this->url->link('dashboard/common/login', '', 'SSL');
		...
		if ($this->config->get('config_password')) {
			$data['forgotten'] = $this->url->link('dashboard/common/forgotten', '', 'SSL');
		} else {
			$data['forgotten'] = '';
		}

		$data['header'] = $this->load->controller('common/header', ["class" => "login-content"]);
