...
class ControllerTotalSubTotal extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('dashboard/total/sub_total', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['action'] = $this->url->link('dashboard/total/sub_total', 'token=' . $this->session->data['token'], 'SSL');

		$data['cancel'] = $this->url->link('dashboard/extension/total', 'token=' . $this->session->data['token'], 'SSL');
