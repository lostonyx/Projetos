...
class ControllerTotalTotal extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('dashboard/total/total', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['action'] = $this->url->link('dashboard/total/total', 'token=' . $this->session->data['token'], 'SSL');
