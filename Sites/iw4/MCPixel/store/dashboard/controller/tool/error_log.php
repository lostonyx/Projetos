...
class ControllerToolErrorLog extends Controller {
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('dashboard/tool/error_log', 'token=' . $this->session->data['token'], 'SSL')
        );

        $data['download'] = $this->url->link('dashboard/tool/error_log/download', 'token=' . $this->session->data['token'], 'SSL');
        $data['clear'] = $this->url->link('dashboard/tool/error_log/clear', 'token=' . $this->session->data['token'], 'SSL');
    ...
    public function clear() {
        ...
        $this->response->redirect($this->url->link('dashboard/tool/error_log', 'token=' . $this->session->data['token'], 'SSL'));
    }
