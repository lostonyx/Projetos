...
class ControllerToolUpload extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			$this->response->redirect($this->url->link('dashboard/tool/upload', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('dashboard/tool/upload', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);

		$data['delete'] = $this->url->link('dashboard/tool/upload/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['uploads'][] = array(
				...
				'download'   => $this->url->link('dashboard/tool/upload/download', 'token=' . $this->session->data['token'] . '&code=' . $result['code'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('dashboard/tool/upload', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
		$data['sort_filename'] = $this->url->link('dashboard/tool/upload', 'token=' . $this->session->data['token'] . '&sort=filename' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('dashboard/tool/upload', 'token=' . $this->session->data['token'] . '&sort=date_added' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('dashboard/tool/upload', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
