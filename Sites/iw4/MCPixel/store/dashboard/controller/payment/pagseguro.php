...
class ControllerPaymentPagseguro extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('dashboard/payment/pagseguro', 'token=' . $this->session->data['token'], 'SSL')
		);		
		
		$data['action'] = $this->url->link('dashboard/payment/pagseguro', 'token=' . $this->session->data['token'], 'SSL');
