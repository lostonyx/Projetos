...
class ControllerPaymentPPExpress extends Controller {
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->response->redirect($this->url->link('dashboard/extension/payment', 'token=' . $this->session->data['token'], 'SSL'));
        }
        ...
        $data['text_ipn_url'] = 'payment/pp_express/ipn';
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('dashboard/extension/payment', 'token=' . $this->session->data['token'], 'SSL'),
        );

        $data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title'),
            'href' => $this->url->link('dashboard/payment/pp_express', 'token=' . $this->session->data['token'], 'SSL'),
        );

        $data['action'] = $this->url->link('dashboard/payment/pp_express', 'token=' . $this->session->data['token'], 'SSL');
        $data['cancel'] = $this->url->link('dashboard/extension/payment', 'token=' . $this->session->data['token'], 'SSL');
        $data['search'] = $this->url->link('dashboard/payment/pp_express/search', 'token=' . $this->session->data['token'], 'SSL');
        ...
        if (isset($this->request->post['pp_express_logo']) && is_file(DIR_DASHBOARD_IMAGE . $this->request->post['pp_express_logo'])) {
            $data['thumb'] = $this->model_tool_image->resize($this->request->post['pp_express_logo'], 750, 90);
        } elseif (is_file(DIR_DASHBOARD_IMAGE . $this->config->get('pp_express_logo'))) {
        ...
        $data['text_paypal_link'] = 'https://www.paypal.com/webapps/merchantboarding/webflow/externalpartnerflow?'
            ...
            . '&returnToPartnerUrl=' . base64_encode(html_entity_decode($this->url->link('dashboard/payment/pp_express/live', 'token=' . $this->session->data['token'], 'SSL')))
        ...
        $data['text_paypal_link_sandbox'] = 'https://www.sandbox.paypal.com/webapps/merchantboarding/webflow/externalpartnerflow?'
            ...
            . '&productIntentID=addipmt'
            . '&receiveCredentials=TRUE'
            . '&returnToPartnerUrl=' . base64_encode(html_entity_decode($this->url->link('dashboard/payment/pp_express/sandbox', 'token=' . $this->session->data['token'], 'SSL')))
            . '&subIntegrationType=S';
    ...
    public function live() {
        ...
        $this->response->redirect($this->url->link('dashboard/payment/pp_express', 'token=' . $this->session->data['token'], 'SSL'));
    }
    ...
    public function refund() {
        ...
        $data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title'),
            'href' => $this->url->link('dashboard/payment/pp_express/refund', 'token=' . $this->session->data['token'], 'SSL'),
        );

        //button actions
        $data['action'] = $this->url->link('dashboard/payment/pp_express/doRefund', 'token=' . $this->session->data['token'], 'SSL');
        $data['cancel'] = $this->url->link('dashboard/payment/pp_express', 'token=' . $this->session->data['token'], 'SSL');
            ...
            if ($this->request->post['refund_full'] == 0 && $this->request->post['amount'] == 0) {
                ...
                if ($paypal_order) {
                    ...
                    if ($result == false) {
                        ...
                        $this->response->redirect($this->url->link('dashboard/sale/order/info', 'token=' . $this->session->data['token'] . '&order_id=' . $paypal_order['order_id'], 'SSL'));
                        ...
                        $this->response->redirect($this->url->link('dashboard/payment/pp_express/refund', 'token=' . $this->session->data['token'] . '&transaction_id=' . $this->request->post['transaction_id'], 'SSL'));
                    }
                } else {
    ...
    public function order() {
        if ($this->config->get('pp_express_status')) {
            ...
            if ($paypal_order) {
                ...
                $data['refund_link'] = $this->url->link('dashboard/payment/pp_express/refund', 'token=' . $this->session->data['token'], 'SSL');
                $data['view_link'] = $this->url->link('dashboard/payment/pp_express/viewTransaction', 'token=' . $this->session->data['token'], 'SSL');
                $data['resend_link'] = $this->url->link('dashboard/payment/pp_express/resend', 'token=' . $this->session->data['token'], 'SSL');
    ...
    public function search() {
        ...
        $data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title'),
            'href' => $this->url->link('dashboard/payment/pp_express/search', 'token=' . $this->session->data['token'], 'SSL'),
        );
    ...
    public function viewTransaction() {
        ...
        $data['view_link'] = $this->url->link('dashboard/payment/pp_express/viewTransaction', 'token=' . $this->session->data['token'], 'SSL');
        $data['cancel'] = $this->url->link('dashboard/payment/pp_express/search', 'token=' . $this->session->data['token'], 'SSL');
        $data['token'] = $this->session->data['token'];
        ...
        $data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title'),
            'href' => $this->url->link('dashboard/payment/pp_express/viewTransaction', 'token=' . $this->session->data['token'] . '&transaction_id=' . $this->request->get['transaction_id'], 'SSL'),
        );
    ...
    public function recurringCancel() {
        ...
        $this->response->redirect($this->url->link('dashboard/sale/recurring/info', 'order_recurring_id=' . $this->request->get['order_recurring_id'] . '?token=' . $this->request->get['token'], 'SSL'));
    }
    ...
    public function recurringButtons() {
        ...
        if ($recurring['status_id'] == 2 || $recurring['status_id'] == 3) {
            $data['buttons'][] = array(
                ...
                'link' => $this->url->link('dashboard/payment/pp_express/recurringCancel', 'order_recurring_id=' . $this->request->get['order_recurring_id'] . '?token=' . $this->request->get['token'], 'SSL')
            );
        }
