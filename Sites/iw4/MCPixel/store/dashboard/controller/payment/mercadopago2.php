...
include_once '../application/controller/payment/mercadopago.php';
...
class ControllerPaymentMercadopago2 extends Controller {
    ...
    public function index() {
        ...
        $data['action'] = 'dashboard/payment/mercadopago2&token=' . $this->session->data['token'];
        $data['cancel'] = 'dashboard/extension/payment&token=' . $this->session->data['token'];
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
            ...
            $this->response->redirect($this->config->get("config_ssl") . 'dashboard/extension/payment&token=' . $this->session->data['token']);
        }
