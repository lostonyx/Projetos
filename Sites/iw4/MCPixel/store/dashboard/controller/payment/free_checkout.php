...
class ControllerPaymentFreeCheckout extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('dashboard/payment/free_checkout', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['action'] = $this->url->link('dashboard/payment/free_checkout', 'token=' . $this->session->data['token'], 'SSL');
