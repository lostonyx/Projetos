...
class ControllerModuleTextbox extends Controller {
	...
	public function index() {
		$this->load->language('module/textbox');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			if (!isset($this->request->get['module_id'])) {
				$this->model_extension_module->addModule('textbox', $this->request->post);
			} else {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('dashboard/module/textbox', 'token=' . $this->session->data['token'], 'SSL')
		);

		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('dashboard/module/textbox', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$data['action'] = $this->url->link('dashboard/module/textbox', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
		}
		...
		$this->response->setOutput($this->load->view('module/textbox.tpl', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'module/textbox')) {
