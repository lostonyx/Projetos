...
class ControllerModuleCategory extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('dashboard/module/category', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['action'] = $this->url->link('dashboard/module/category', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->error['category_name'])) {
			...
			$data['error_category_name'] = array();
		}

		if (isset($this->error['category_limit'])) {
			$data['error_category_limit'] = $this->error['category_limit'];
		} else {
			$data['error_category_limit'] = array();
		}
