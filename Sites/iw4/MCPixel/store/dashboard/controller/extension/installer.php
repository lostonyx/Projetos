...
class ControllerExtensionInstaller extends Controller {
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('dashboard/extension/installer', 'token=' . $this->session->data['token'], 'SSL')
        );
    ...
    public function upload() {
        ...
        if (!$json) {
            if (!empty($this->request->files['file']['name'])) {
                if (substr($this->request->files['file']['name'], -11) != '.iw4mod.zip' && substr($this->request->files['file']['name'], -11) != '.iw4mod.xml') {
            ...
            if (strrchr($this->request->files['file']['name'], '.') == '.xml') {
                ...
                if (file_exists($file)) {
                    $json['step'][] = array(
                        ...
                        'url'  => str_replace('&amp;', '&', $this->url->link('dashboard/extension/installer/xml', 'token=' . $this->session->data['token'], 'SSL')),
                        'path' => $path
                    );
                    ...
                    $json['step'][] = array(
                        ...
                        'url'  => str_replace('&amp;', '&', $this->url->link('dashboard/extension/installer/remove', 'token=' . $this->session->data['token'], 'SSL')),
                        'path' => $path
                    );
                } else {
                ...
                if (file_exists($file)) {
                    ...
                    if ($zip) {
                        ...
                        $json['step'][] = array(
                            ...
                            'url'  => str_replace('&amp;', '&', $this->url->link('dashboard/extension/installer/unzip', 'token=' . $this->session->data['token'], 'SSL')),
                            'path' => $path
                        );
                        ...
                        $json['step'][] = array(
                            ...
                            'url'  => str_replace('&amp;', '&', $this->url->link('dashboard/extension/installer/ftp', 'token=' . $this->session->data['token'], 'SSL')),
                            'path' => $path
                        );
                        ...
                        while ($entry = zip_read($zip)) {
                            ...
                            if (substr($zip_name, 0, 11) == 'install.sql') {
                                $json['step'][] = array(
                                    ...
                                    'url'  => str_replace('&amp;', '&', $this->url->link('dashboard/extension/installer/sql', 'token=' . $this->session->data['token'], 'SSL')),
                                    'path' => $path
                                );
                            }
                            ...
                            if (substr($zip_name, 0, 11) == 'install.php') {
                                $json['step'][] = array(
                                    ...
                                    'url'  => str_replace('&amp;', '&', $this->url->link('dashboard/extension/installer/php', 'token=' . $this->session->data['token'], 'SSL')),
                                    'path' => $path
                                );
                            }
                            ...
                            // Compare image files
                            $file = DIR_DASHBOARD_IMAGE . substr($zip_name, 13);
    ...
    public function ftp() {
        ...
        if (!$json) {
            ...
            $connection = ftp_connect($this->config->get('config_ftp_hostname'), $this->config->get('config_ftp_port'), 5);
                ...
                if ($login) {
                    ...
                    if ($root) {
                        foreach ($files as $file) {
                            ...
                            if (substr($destination, 0, 9) == 'dashboard') {
                                $destination = basename(DIR_APPLICATION) . substr($destination, 9);
                            }

                            if (substr($destination, 0, 11) == 'application') {
                                $destination = basename(DIR_CATALOG) . substr($destination, 11);
                            }

                            if (substr($destination, 0, 5) == 'image') {
                                $destination = basename(DIR_DASHBOARD_IMAGE) . substr($destination, 5);
                            }
