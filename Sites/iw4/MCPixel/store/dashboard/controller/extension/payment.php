        ...
        if ($files) {
            foreach ($files as $file) {
                ...
                $data['extensions'][] = array(
                    ...
                    'install'    => $this->url->link('dashboard/extension/payment/install', 'token=' . $this->session->data['token'] . '&extension=' . $extension, 'SSL'),
                    'uninstall'  => $this->url->link('dashboard/extension/payment/uninstall', 'token=' . $this->session->data['token'] . '&extension=' . $extension, 'SSL'),
                    'installed'  => in_array($extension, $extensions),
                    'edit'       => $this->url->link('dashboard/payment/' . $extension . '', 'token=' . $this->session->data['token'], 'SSL')
                );
            }
        }
