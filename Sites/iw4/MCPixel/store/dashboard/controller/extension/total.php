...
class ControllerExtensionTotal extends Controller {
	...
	public function install() {
		...
		if ($this->validate()) {
			...
			$this->response->redirect($this->url->link('dashboard/extension/total', 'token=' . $this->session->data['token'], 'SSL'));
		}
	...
	public function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('dashboard/extension/total', 'token=' . $this->session->data['token'], 'SSL')
		);
		...
		if ($files) {
			foreach ($files as $file) {
				...
				$data['extensions'][] = array(
					...
					'install'   => $this->url->link('dashboard/extension/total/install', 'token=' . $this->session->data['token'] . '&extension=' . $extension, 'SSL'),
					'uninstall' => $this->url->link('dashboard/extension/total/uninstall', 'token=' . $this->session->data['token'] . '&extension=' . $extension, 'SSL'),
					'installed' => in_array($extension, $extensions),
					'edit'      => $this->url->link('dashboard/total/' . $extension . '', 'token=' . $this->session->data['token'], 'SSL')
				);
			}
		}
