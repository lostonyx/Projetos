...
class ControllerExtensionModule extends Controller {
	...
	public function getList() {
		...
		$data['text_layout'] = sprintf($this->language->get('text_layout'), $this->url->link('dashboard/design/layout', 'token=' . $this->session->data['token'], 'SSL'));
		...
		$data['delete'] = $this->url->link('dashboard/extension/module/delete', 'token=' . $this->session->data['token'], 'SSL');
			...
			foreach ($files as $file) {
				...
				foreach ($modules as $module) {
					$module_data[] = array(
						...
						'edit'      => $this->url->link('dashboard/module/' . $extension, 'token=' . $this->session->data['token'] . '&module_id=' . $module['module_id'], 'SSL'),
						'delete'    => $this->url->link('dashboard/extension/module/delete', 'token=' . $this->session->data['token'] . '&module_id=' . $module['module_id'], 'SSL')
					);
				}
				...
				$data['extensions'][] = array(
					...
					'module'    => $module_data,
					'install'   => $this->url->link('dashboard/extension/module/install', 'token=' . $this->session->data['token'] . '&extension=' . $extension, 'SSL'),
					'uninstall' => $this->url->link('dashboard/extension/module/uninstall', 'token=' . $this->session->data['token'] . '&extension=' . $extension, 'SSL'),
					'installed' => in_array($extension, $extensions),
					'edit'      => $this->url->link('dashboard/module/' . $extension, 'token=' . $this->session->data['token'], 'SSL')
				);
			}
		}
