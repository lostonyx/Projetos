...
class ControllerUserApi extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('dashboard/user/api', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('dashboard/user/api', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('dashboard/user/api/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('dashboard/user/api/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['apis'][] = array(
				...
				'edit'       => $this->url->link('dashboard/user/api/edit', 'token=' . $this->session->data['token'] . '&api_id=' . $result['api_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('dashboard/user/api', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('dashboard/user/api', 'token=' . $this->session->data['token'] . '&sort=status' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('dashboard/user/api', 'token=' . $this->session->data['token'] . '&sort=date_added' . $url, 'SSL');
		$data['sort_date_updated'] = $this->url->link('dashboard/user/api', 'token=' . $this->session->data['token'] . '&sort=date_updated' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('dashboard/user/api', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['api_id'])) {
			$data['action'] = $this->url->link('dashboard/user/api/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('dashboard/user/api/edit', 'token=' . $this->session->data['token'] . '&api_id=' . $this->request->get['api_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('dashboard/user/api', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		if (isset($this->request->get['api_id'])) {
			...
			foreach ($results as $result) {
				$data['api_sessions'][] = array(
					...
					'date_updated'  => date($this->language->get('datetime_format'), strtotime($result['date_updated']))
				);
			}
		}
