...
class ControllerLocalisationCurrency extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('dashboard/localisation/currency', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('dashboard/localisation/currency', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('dashboard/localisation/currency/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('dashboard/localisation/currency/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['refresh'] = $this->url->link('dashboard/localisation/currency/refresh', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['currencies'][] = array(
				...
				'edit'          => $this->url->link('dashboard/localisation/currency/edit', 'token=' . $this->session->data['token'] . '&currency_id=' . $result['currency_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_title'] = $this->url->link('dashboard/localisation/currency', 'token=' . $this->session->data['token'] . '&sort=title' . $url, 'SSL');
		$data['sort_code'] = $this->url->link('dashboard/localisation/currency', 'token=' . $this->session->data['token'] . '&sort=code' . $url, 'SSL');
		$data['sort_value'] = $this->url->link('dashboard/localisation/currency', 'token=' . $this->session->data['token'] . '&sort=value' . $url, 'SSL');
		$data['sort_date_updated'] = $this->url->link('dashboard/localisation/currency', 'token=' . $this->session->data['token'] . '&sort=date_updated' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('dashboard/localisation/currency', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['currency_id'])) {
			$data['action'] = $this->url->link('dashboard/localisation/currency/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('dashboard/localisation/currency/edit', 'token=' . $this->session->data['token'] . '&currency_id=' . $this->request->get['currency_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('dashboard/localisation/currency', 'token=' . $this->session->data['token'] . $url, 'SSL');
