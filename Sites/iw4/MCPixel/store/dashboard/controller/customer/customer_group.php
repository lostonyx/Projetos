...
class ControllerCustomerCustomerGroup extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('dashboard/customer/customer_group', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('dashboard/customer/customer_group', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('dashboard/customer/customer_group/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('dashboard/customer/customer_group/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['customer_groups'][] = array(
				...
				'edit'              => $this->url->link('dashboard/customer/customer_group/edit', 'token=' . $this->session->data['token'] . '&customer_group_id=' . $result['customer_group_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('dashboard/customer/customer_group', 'token=' . $this->session->data['token'] . '&sort=cgd.name' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('dashboard/customer/customer_group', 'token=' . $this->session->data['token'] . '&sort=cg.sort_order' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('dashboard/customer/customer_group', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['customer_group_id'])) {
			$data['action'] = $this->url->link('dashboard/customer/customer_group/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('dashboard/customer/customer_group/edit', 'token=' . $this->session->data['token'] . '&customer_group_id=' . $this->request->get['customer_group_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('dashboard/customer/customer_group', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		if (isset($this->request->post['customer_group_lang'])) {
			$data['customer_group_lang'] = $this->request->post['customer_group_lang'];
		} elseif (isset($this->request->get['customer_group_id'])) {
			$data['customer_group_lang'] = $this->model_customer_customer_group->getCustomerGroupDescriptions($this->request->get['customer_group_id']);
		} else {
			$data['customer_group_lang'] = array();
		}
	...
	protected function validateForm() {
		...
		foreach ($this->request->post['customer_group_lang'] as $language_id => $value) {
