...
class ControllerMarketingContact extends Controller {
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('dashboard/marketing/contact', 'token=' . $this->session->data['token'], 'SSL')
        );

        $data['cancel'] = $this->url->link('dashboard/marketing/contact', 'token=' . $this->session->data['token'], 'SSL');
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST') {
            ...
            if (!$json) {
                ...
                if ($emails) {
                    ...
                    if ($end < $email_total) {
                        $json['next'] = str_replace('&amp;', '&', $this->url->link('dashboard/marketing/contact/send', 'token=' . $this->session->data['token'] . '&page=' . ($page + 1), 'SSL'));
                    } else {
                        $json['next'] = '';
                    }
