...
class ControllerMarketingMarketing extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('dashboard/marketing/marketing', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('dashboard/marketing/marketing', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('dashboard/marketing/marketing/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('dashboard/marketing/marketing/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['marketings'][] = array(
				...
				'edit'         => $this->url->link('dashboard/marketing/marketing/edit', 'token=' . $this->session->data['token'] . '&marketing_id=' . $result['marketing_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('dashboard/marketing/marketing', 'token=' . $this->session->data['token'] . '&sort=m.name' . $url, 'SSL');
		$data['sort_code'] = $this->url->link('dashboard/marketing/marketing', 'token=' . $this->session->data['token'] . '&sort=m.code' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('dashboard/marketing/marketing', 'token=' . $this->session->data['token'] . '&sort=m.date_added' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('dashboard/marketing/marketing', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['marketing_id'])) {
			$data['action'] = $this->url->link('dashboard/marketing/marketing/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('dashboard/marketing/marketing/edit', 'token=' . $this->session->data['token'] . '&marketing_id=' . $this->request->get['marketing_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('dashboard/marketing/marketing', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$data['store'] = $this->config->get("config_url");
