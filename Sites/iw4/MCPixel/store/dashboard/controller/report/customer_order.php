...
class ControllerReportCustomerOrder extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('dashboard/report/customer_order', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$pagination->url = $this->url->link('dashboard/report/customer_order', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
