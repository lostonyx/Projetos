...
class ControllerReportMarketing extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('dashboard/report/marketing', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('dashboard/marketing/marketing/edit', 'token=' . $this->session->data['token'] . '&marketing_id=' . $result['marketing_id'] . $url, 'SSL')
			);
		...
		$pagination->url = $this->url->link('dashboard/report/marketing', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
