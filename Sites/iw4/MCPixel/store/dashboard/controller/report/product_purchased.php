...
class ControllerReportProductPurchased extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('dashboard/report/product_purchased', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$pagination->url = $this->url->link('dashboard/report/product_purchased', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
