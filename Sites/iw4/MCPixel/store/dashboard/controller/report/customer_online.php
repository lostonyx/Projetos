...
class ControllerReportCustomerOnline extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('dashboard/report/customer_online', 'token=' . $this->session->data['token'] . $url, 'SSL'),
		...
		foreach ($results as $result) {
			...
			$data['customers'][] = array(
				...
				'edit'        => $this->url->link('dashboard/customer/customer/edit', 'token=' . $this->session->data['token'] . '&customer_id=' . $result['customer_id'], 'SSL')
			);
		}
		...
		$pagination->url = $this->url->link('dashboard/report/customer_online', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
