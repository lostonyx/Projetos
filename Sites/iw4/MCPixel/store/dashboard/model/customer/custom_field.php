...
class ModelCustomerCustomField extends Model {
	public function addCustomField($data) {
		...
		foreach ($data['custom_field_lang'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "custom_field_lang SET custom_field_id = '" . (int)$custom_field_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "'");
		}
		...
		if (isset($data['custom_field_value'])) {
			foreach ($data['custom_field_value'] as $custom_field_value) {
				...
				foreach ($custom_field_value['custom_field_value_lang'] as $language_id => $custom_field_value_lang) {
					$this->db->query("INSERT INTO " . DB_PREFIX . "custom_field_value_lang SET custom_field_value_id = '" . (int)$custom_field_value_id . "', language_id = '" . (int)$language_id . "', custom_field_id = '" . (int)$custom_field_id . "', name = '" . $this->db->escape($custom_field_value_lang['name']) . "'");
				}
			}
		}
	}
	...
	public function editCustomField($custom_field_id, $data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "custom_field_lang WHERE custom_field_id = '" . (int)$custom_field_id . "'");
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "custom_field_value_lang WHERE custom_field_id = '" . (int)$custom_field_id . "'");
	...
	public function getCustomField($custom_field_id) {
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "custom_field` cf LEFT JOIN " . DB_PREFIX . "custom_field_lang cfd ON (cf.custom_field_id = cfd.custom_field_id) WHERE cf.custom_field_id = '" . (int)$custom_field_id . "' AND cfd.language_id = '" . (int)$this->config->get('config_language_id') . "'");
	...
	public function getCustomFields($data = array()) {
		if (empty($data['filter_customer_group_id'])) {
			$sql = "SELECT * FROM `" . DB_PREFIX . "custom_field` cf LEFT JOIN " . DB_PREFIX . "custom_field_lang cfd ON (cf.custom_field_id = cfd.custom_field_id) WHERE cfd.language_id = '" . (int)$this->config->get('config_language_id') . "'";
		} else {
			$sql = "SELECT * FROM " . DB_PREFIX . "custom_field_customer_group cfcg LEFT JOIN `" . DB_PREFIX . "custom_field` cf ON (cfcg.custom_field_id = cf.custom_field_id) LEFT JOIN " . DB_PREFIX . "custom_field_lang cfd ON (cf.custom_field_id = cfd.custom_field_id) WHERE cfd.language_id = '" . (int)$this->config->get('config_language_id') . "'";
		}
	...
	public function getCustomFieldDescriptions($custom_field_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "custom_field_lang WHERE custom_field_id = '" . (int)$custom_field_id . "'");
	...
	public function getCustomFieldValue($custom_field_value_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "custom_field_value cfv LEFT JOIN " . DB_PREFIX . "custom_field_value_lang cfvd ON (cfv.custom_field_value_id = cfvd.custom_field_value_id) WHERE cfv.custom_field_value_id = '" . (int)$custom_field_value_id . "' AND cfvd.language_id = '" . (int)$this->config->get('config_language_id') . "'");
	...
	public function getCustomFieldValues($custom_field_id) {
		...
		$custom_field_value_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "custom_field_value cfv LEFT JOIN " . DB_PREFIX . "custom_field_value_lang cfvd ON (cfv.custom_field_value_id = cfvd.custom_field_value_id) WHERE cfv.custom_field_id = '" . (int)$custom_field_id . "' AND cfvd.language_id = '" . (int)$this->config->get('config_language_id') . "' ORDER BY cfv.sort_order ASC");
	...
	public function getCustomFieldValueDescriptions($custom_field_id) {
		...
		foreach ($custom_field_value_query->rows as $custom_field_value) {
			$custom_field_value_lang_data = array();

			$custom_field_value_lang_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "custom_field_value_lang WHERE custom_field_value_id = '" . (int)$custom_field_value['custom_field_value_id'] . "'");

			foreach ($custom_field_value_lang_query->rows as $custom_field_value_lang) {
				$custom_field_value_lang_data[$custom_field_value_lang['language_id']] = array('name' => $custom_field_value_lang['name']);
			}

			$custom_field_value_data[] = array(
				'custom_field_value_id'          => $custom_field_value['custom_field_value_id'],
				'custom_field_value_lang' => $custom_field_value_lang_data,
