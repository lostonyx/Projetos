...
class ModelCustomerCustomer extends Model {
    ...
    public function getCustomers($data = array()) {
        $sql = "SELECT *, CONCAT(c.firstname, ' ', c.lastname) AS name, cgd.name AS customer_group FROM " . DB_PREFIX . "customer c LEFT JOIN " . DB_PREFIX . "customer_group_lang cgd ON (c.customer_group_id = cgd.customer_group_id) WHERE cgd.language_id = '" . (int)$this->config->get('config_language_id') . "'";
    ...
    public function approve($customer_id) {
        ...
        if ($customer_info) {
            ...
            $store_url = $this->config->get("config_url") . 'dashboard/account/login';
