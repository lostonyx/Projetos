...
function country(element, index, zone_id) {
	$.ajax({
		url: 'dashboard/localisation/country/country?token=<?php echo $token; ?>&country_id=' + element.value,
		dataType: 'json',
		beforeSend: function() {
...
$('#history').load('dashboard/customer/customer/history?token=<?php echo $token; ?>&customer_id=<?php echo $customer_id; ?>');

$('#button-history').on('click', function(e) {
	e.preventDefault();

	$.ajax({
		url: 'dashboard/customer/customer/addhistory?token=<?php echo $token; ?>&customer_id=<?php echo $customer_id; ?>',
		type: 'post',
		dataType: 'json',
...
$('#transaction').load('dashboard/customer/customer/transaction?token=<?php echo $token; ?>&customer_id=<?php echo $customer_id; ?>');

$('#button-transaction').on('click', function(e) {
  e.preventDefault();

  $.ajax({
		url: 'dashboard/customer/customer/addtransaction?token=<?php echo $token; ?>&customer_id=<?php echo $customer_id; ?>',
		type: 'post',
		dataType: 'json',
...
$('#ip').load('dashboard/customer/customer/ip?token=<?php echo $token; ?>&customer_id=<?php echo $customer_id; ?>');
