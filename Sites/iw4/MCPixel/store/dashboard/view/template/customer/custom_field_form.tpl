        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-custom-field" class="form-horizontal">
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <div class="input-group"><span class="input-group-addon"><img src="dashboard/view/image/flags/<?php echo $language['image']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                <input type="text" name="custom_field_lang[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($custom_field_lang[$language['language_id']]) ? $custom_field_lang[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" class="form-control" />
              </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="type" id="input-type" class="form-control">
                ...
                <?php if ($type == 'player2uuid') { ?>
                <option value="player2uuid" selected="selected"><?php echo $text_player2uuid; ?></option>
                <?php } else { ?>
                <option value="player2uuid"><?php echo $text_player2uuid; ?></option>
                <?php } ?>
            ...
            <tbody>
              ...
              <tr id="custom-field-value-row<?php echo $custom_field_value_row; ?>">
                <td class="text-left" style="width: 70%;"><input type="hidden" name="custom_field_value[<?php echo $custom_field_value_row; ?>][custom_field_value_id]" value="<?php echo $custom_field_value['custom_field_value_id']; ?>" />
                  <?php foreach ($languages as $language) { ?>
                  <div class="input-group"> <span class="input-group-addon"><img src="dashboard/view/image/flags/<?php echo $language['image']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                    <input type="text" name="custom_field_value[<?php echo $custom_field_value_row; ?>][custom_field_value_lang][<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($custom_field_value['custom_field_value_lang'][$language['language_id']]) ? $custom_field_value['custom_field_value_lang'][$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_custom_value; ?>" class="form-control" />
                  </div>
...
function addCustomFieldValue() {
	...
	html += '      <span class="input-group-addon"><img src="dashboard/view/image/flags/<?php echo $language['image']; ?>.png" title="<?php echo $language['name']; ?>" /></span><input type="text" name="custom_field_value[' + custom_field_value_row + '][custom_field_value_lang][<?php echo $language['language_id']; ?>][name]" value="" placeholder="<?php echo $entry_custom_value; ?>" class="form-control" />';
    html += '    </div>';
	<?php } ?>
	html += '  </td>';
