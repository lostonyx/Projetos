          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <div class="input-group"><span class="input-group-addon"><img src="dashboard/view/image/flags/<?php echo $language['image']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                <input type="text" name="recurring_lang[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($recurring_lang[$language['language_id']]) ? $recurring_lang[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" class="form-control" />
              </div>
