...
<div id="content">
    <div class="block-header">
        <div class="pull-right">
            <button type="submit" form="form_mp" class="btn btn-primary"><i class="fa fa-save"></i></button>
            <a onclick="location = '<?php echo $cancel; ?>';" class="btn btn-default"><i class="fa fa-reply"></i></a>
        </div>
