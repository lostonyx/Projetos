        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label" for="input-date-modified"><?php echo $entry_date_updated; ?></label>
                <div class="input-group date">
                  <input type="text" name="filter_date_updated" value="<?php echo $filter_date_updated; ?>" placeholder="<?php echo $entry_date_updated; ?>" data-date-format="YYYY-MM-DD" id="input-date-modified" class="form-control" />
                  <span class="input-group-btn">
                  <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                  </span></div>
              </div>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'o.date_added') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'o.date_updated') { ?>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $order['date_updated']; ?></td>
...
$('#button-filter').on('click', function() {
	url = 'dashboard/sale/order?token=<?php echo $token; ?>';
...
$.ajax({
	url: '<?php echo $store; ?>api/login?key=<?php echo $api_key; ?>',
	type: 'get',
	dataType: 'json',
	crossDomain: true,
	success: function(json) {
...
$('button[id^=\'button-delete\']').on('click', function(e) {
	if (confirm('<?php echo $text_confirm; ?>')) {
		...
		$.ajax({
			url: '<?php echo $store; ?>api/order/delete?token=' + token + '&order_id=' + $(node).val(),
			dataType: 'json',
			crossDomain: true,
			beforeSend: function() {
				$(node).button('loading');
