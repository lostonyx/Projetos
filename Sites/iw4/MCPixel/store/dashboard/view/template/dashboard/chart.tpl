...
<script type="text/javascript" src="dashboard/view/javascript/jquery/flot/jquery.flot.js"></script>
<script type="text/javascript" src="dashboard/view/javascript/jquery/flot/jquery.flot.resize.min.js"></script>
...
$('#range a').on('click', function(e) {
	...
	$.ajax({
		type: 'get',
		url: 'dashboard/dashboard/chart/chart?token=<?php echo $token; ?>&range=' + $(this).attr('href'),
		dataType: 'json',
