              ...
              <table id="session" class="table table-striped table-bordered table-hover">
                <thead>
                  <tr>
                    ...
                    <td class="text-left"><?php echo $column_date_updated; ?></td>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-left"><?php echo $api_session['date_updated']; ?></td>
...
$('#session button').on('click', function(e) {
	...
	if (confirm('<?php echo $text_confirm; ?>')) {
		...
		$.ajax({
			url: 'dashboard/user/api/deletesession?token=<?php echo $token; ?>&api_session_id=' + $(node).val(),
			type: 'post',
			dataType: 'json',
			beforeSend: function() {
				$(node).button('loading');
