...
class ControllerCheckoutRegister extends Controller {
    ...
    public function save() {
        ...
        if ($this->customer->isLogged()) {
            $json['redirect'] = $this->url->link('checkout/view', '', 'SSL');
        }

        // Validate cart has products and has stock.
        if (!$this->cart->hasProducts()) {
            $json['error']['warning'] = $this->language->get('error_no_product');
        }
                ...
                if ($custom_field['required'] && empty($this->request->post['custom_field'][$custom_field['location']][$custom_field['custom_field_id']])) {
                    ...
                    if ($custom_field['type'] == "player2uuid") {
                        ...
                        if (empty($pl) || isset($pl['error'])) {
                            $json['error']['custom-field'.$custom_field['custom_field_id']] = $this->language->get('error_cf_player_invalid');
                        } else {
