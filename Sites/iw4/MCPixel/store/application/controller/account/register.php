    ...
    public function index() {
        ...
        foreach ($data['custom_fields'] as $cf) {
            if ($cf['type'] == "player2uuid") {
                $value = (isset($data['register_custom_field'][$cf['custom_field_id']]) ? $data['register_custom_field'][$cf['custom_field_id']] : $cf['value']);
                if (empty($value)) {
                    continue;
                }
                ...
                $data['register_custom_field'][$cf['custom_field_id']] = $player['name'];
            }
        }
        ...
        foreach ($custom_fields as $custom_field) {
            if ($custom_field['required'] && empty($this->request->post['custom_field'][$custom_field['location']][$custom_field['custom_field_id']])) {
                ...
                if ($custom_field['type'] == "player2uuid") {
                    $value = str_replace("-", "", $this->request->post['custom_field'][$custom_field['location']][$custom_field['custom_field_id']]);
                    ...
                    if (empty($pl) || isset($pl['error'])) {
                        ...
                        $this->request->post['custom_field'][$custom_field['location']][$custom_field['custom_field_id']] = $pl['id'];
                    }
                }
            }
        }
