    ...
    public function index() {
        ...
        foreach ($data['custom_fields'] as $cf) {
            if ($cf['type'] == "player2uuid") {
                $value = (isset($data['account_custom_field'][$cf['custom_field_id']]) ? $data['account_custom_field'][$cf['custom_field_id']] : $cf['value']);
                if (empty($value)) {
                    continue;
                }
                ...
                $data['account_custom_field'][$cf['custom_field_id']] = $player['name'];
            }
        }
