...
class ControllerPaymentMercadopago2 extends Controller {
    ...
    public function index() {
        ...
        foreach ($all_products as $product) {
            ...
            $items[] = array(
                ...
                "picture_url" => $this->config->get("config_ssl") . 'dashboard/view/image/catalog/' . $product['image'],
        ...
        //set back url
        $back_urls = array(
            "pending" => $url . '/payment/mercadopago2/callback',
            "success" => $url . '/payment/mercadopago2/callback'
        );
    ...
    public function notifications() {
        if ($this->request->get['topic'] == 'payment') {
            $this->request->get['collection_id'] = (isset($this->request->get['id']) ? $this->request->get['id'] : $this->request->get['collection_id']);
            $this->retorno();
