	...
	<div class="content-wrapper">
		<div class="blank">
			...
			<?php
    			foreach ($logs as $log){
    			    $arr['id']   = $log->id;
    			    $_SESSION['editchangelog'] = $arr;
    			    echo '
    				<div class="col-md-9">
    										<div class="bg">
    						<h3>Edite um changelog</h3>
    						<br>
    							<div class="row">
                                    '.form_open("/admin/changelog/save/").'
    								<div class="form-group">
                                    <div>
                                    <td align="right" valign="top" nowrap="nowrap">
                                    <label>Texto: </label>
                                    <textarea id="texto" name="texto" rows="11" style="width:650px">'.$log->texto.'</textarea><script>
