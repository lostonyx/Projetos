package co.saomc.chunkspawnerlimit.commands;
                    ...
                    for (BlockState block : c.getTileEntities()) {
                        if(block instanceof CreatureSpawner){
                            ...
                            if(spawnercount > limit){
                                sender.sendMessage("Acima do limite spawner: " + block.getLocation().getBlockX() + " " + block.getLocation().getBlockY() + " " + block.getLocation().getBlockZ() + " " + block.getLocation().getWorld().getName());
                            }
                        }
                    }
                }   });
