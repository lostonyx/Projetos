...
public class License {//sietema de licensa :)
	...
	public boolean register(){
		log(0, "[]==========[Sistema de Licensa]==========[]");
		log(0, "Vereficando o server ...");
		ValidationType vt = isValid();
		if(vt == ValidationType.VALID){
			log(1, "Licensa valida!");
			log(0, "[]==========[Sistema de Licensa]==========[]");
			return true;
		}else{
			log(1, "Licensa invalida!");
			log(1, "Resultado dando error "+vt.toString());
			log(1, "Desligando plugin!");
			log(0, "[]==========[Sistema de Licensa]==========[]");
