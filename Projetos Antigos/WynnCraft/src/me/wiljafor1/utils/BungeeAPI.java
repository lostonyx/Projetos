...
public final class BungeeAPI {
	 ...
	 * @param data
	 */
	public static void sendToServer(String subChannel, String server, Object... data) {
		ByteArrayDataOutput out = ByteStreams.newDataOutput();
	...
	public static void sendToPlayer(String playerName, String subChannel, Object... data) {
		ByteArrayDataOutput out = ByteStreams.newDataOutput();
